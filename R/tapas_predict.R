...
#' falls in the tails of the TAPAS model. If `FALSE` then the the TAPAS model predicted threshold
...
#' @return A `list` containing the TAPAS predicted subject-specific threshold (`subject_threshold`), the lesion
